                  ...
                  <form method="POST" action="{{ route('admin.create') }}">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" class="form-control input-lg" name="name" aria-describedby="nameHelp" placeholder="Name" required autofocus autocomplete="name" value="{{old('name')}}">
                            <span class="text-danger">@error('name'){{ $message }}@enderror</span>
                      </div>
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" name="email" aria-describedby="emailHelp" placeholder="Email" required  value="{{old('email')}}">
                      ...
                      <div class="form-group col-md-12 ">
                        <input type="password" class="form-control input-lg" ="password" placeholder="Confirm Password"  name ="cpassword">
